...
// recuperer et afficher les infos du produit (si id ok)
...
// ajuter un produit au panier
// debug($_SESSION);
if(isset($_POST['ajout'])){
// si quelqu'un a cliqué sur le bouton d'ajout au panier.

    if($_POST['quantite'] != 0){
     ajoutPanier($_POST['quantite'], $id_produit, $prix, $titre, $photo);
     $_SESSION['validation'][] = 'Le produit <b>' . '<-b> a bien été ajouté au panier, en ' . $_POST['quantite'] . 'exemplaire(s)';
...
<div class="row">
      <div class="col-lg-12">
        ...
        <div class="card mt-4">
          ...
          <?php else : ?>
            <em>Produit victime de son succès. Impossible actuellement. </em>
            <?php endif; ?>
        </div>
        <!-- /.card -->
